...
export const UserDetailPage = () => {
  ...
  return (
    <section className={styles.page}>
      ...
      <header className={styles.header}>
        <div className={styles.headerLead}>
          ...
          <div>
            ...
            <p>Consulte o edite los datos institucionales. La edición queda registrada en auditoría (WF-18).</p>
          </div>
        </div>
        {mode === 'view' && !isLoading && !loadError && (
          <div className={styles.headerActions}>
            <Button type="button" onClick={() => { setSaveMessage(null); setMode('edit'); }}>Editar</Button>
          </div>
        )}
      </header>
      ...
      <Link className={styles.backLink} to="/admin/users/directory">Volver al directorio</Link>
    </section>
  );
};
