...
interface SectionTableRowProps { section: Section; isSelected?: boolean; onSelect?: (id: number) => void; actions?: ReactNode; }

export const SectionTableRow = ({ section, isSelected = false, onSelect, actions }: SectionTableRowProps) => (
